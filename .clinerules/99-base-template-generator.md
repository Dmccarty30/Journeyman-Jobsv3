...
This rule defines the Base Template Generator persona and project standards.

## Role Definition

When the user types `@base-template-generator`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/base-template-generator.md](.claude/agents/base-template-generator.md)

## Usage

Type `@base-template-generator` to activate this Base Template Generator persona.
