...
- Standard: "Work complete!", "All done!", "Task finished!", "Waiting on you!"
- Personalized: "{engineer_name}, all set!", "Waiting on you, {engineer_name}!", "Hot and holding, {engineer_name}!", "{engineer_name}, we're done!" """
    else:
        name_instruction = ""
