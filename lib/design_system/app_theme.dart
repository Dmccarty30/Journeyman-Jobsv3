...
class AppTheme {
  ...
  static const Color electricalBackground =
      Color(0xFF1A202C); // Dark navy with circuit pattern
  static const Color electricalSurface =
      Color(0xFF2D3748); // Secondary navy for components
  static const Color electricalCircuitTrace =
      Color(0xFFB45309); // Copper for circuit traces
  static const Color electricalCircuitTraceLight =
      Color(0xFFD69E2E); // Light copper for traces

  // JJElectricalComponents Notification Colors
  static const Color electricalSuccess =
      Color(0xFF10B981); // Green power indicator
  ...
  static const Duration durationElectricalLightning =
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(radiusMd),
          borderSide:
              const BorderSide(color: accentCopper, width: borderWidthThick),
        ),
        ...
        focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(radiusMd),
          borderSide:
              const BorderSide(color: errorRed, width: borderWidthThick),
        ),
  ...
  static ThemeData get darkTheme {
    ...
    return base.copyWith(
      colorScheme: ColorScheme.fromSeed(
        ...
        // background: primaryNavy, // Deprecated in Flutter 3.22+
        error: errorRed,
        onPrimary: white,
        onSecondary: white,
