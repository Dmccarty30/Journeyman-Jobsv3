        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTwoColumnRow(
                leftLabel: 'Local',
                leftValue: job.localNumber?.toString() ??
                    job.local?.toString() ??
                    'N/A',
              ...
              _buildTwoColumnRow(
                ...
                leftValue:
                    toTitleCase(job.company.isNotEmpty ? job.company : 'N/A'),
              ...
              _buildTwoColumnRow(
                leftLabel: 'Location',
                leftValue:
                    toTitleCase(job.location.isNotEmpty ? job.location : 'N/A'),
                  ...
                  if (leftIcon != null)
                    WidgetSpan(
                      child: Padding(
                        ...
                        child:
                            Icon(leftIcon, size: 16, color: AppTheme.textDark),
                      ),
                    ),
                  TextSpan(
                    text: '$leftLabel: ',
                  ...
                  if (rightIcon != null)
                    WidgetSpan(
                      child: Padding(
                        padding: const EdgeInsets.only(right: 4.0),
                        child:
                            Icon(rightIcon, size: 16, color: AppTheme.textDark),
                      ),
                    ),
                  TextSpan(
                    text: '$rightLabel: ',
